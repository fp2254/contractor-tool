...
function renderBasicClean(data, type, numberField, dateField) {
  return `
    <div style="width: 100%; max-width: 800px; margin: 0 auto; padding: 20px; background: white; color: #000; font-family: Arial, sans-serif; box-sizing: border-box;">
        ...
        <tbody>
          ${data.items?.map(item => `
            <tr style="border: 1px solid #ccc;">
              ...
              <td style="padding: 8px; text-align: center; border: 1px solid #ccc; white-space: nowrap;">${item.quantity ?? item.qty ?? 1}</td>
              <td style="padding: 8px; text-align: right; border: 1px solid #ccc; white-space: nowrap;">$${parseFloat(item.unit_price ?? item.price ?? 0).toFixed(2)}</td>
      ...
      ${data.notes ? `<div style="border-top: 1px solid #ccc; padding-top: 15px; font-size: 11px; color: #666; white-space: pre-line;"><strong>Notes:</strong><br>${data.notes}</div>` : ''}
...
function renderModernPro(data, type, numberField, dateField) {
  return `
    <div style="width: 100%; max-width: 800px; margin: 0 auto; padding: 20px; background: white; color: #000; font-family: 'Segoe UI', Arial, sans-serif; box-sizing: border-box;">
        ...
        <tbody>
          ${data.items?.map((item, i) => `
            <tr style="background: ${i % 2 === 0 ? '#f8f9fa' : 'white'}; border-bottom: 1px solid #e9ecef;">
              ...
              <td style="padding: 10px; text-align: center; white-space: nowrap;">${item.quantity ?? item.qty ?? 1}</td>
              <td style="padding: 10px; text-align: right; white-space: nowrap;">$${parseFloat(item.unit_price ?? item.price ?? 0).toFixed(2)}</td>
      ...
      ${data.notes ? `<div style="background: #f8f9fa; padding: 12px; margin-bottom: 15px; border-left: 3px solid #2c3e50; font-size: 11px; color: #666; white-space: pre-line;"><strong>Notes:</strong><br>${data.notes}</div>` : ''}
  ...
  return `
    <div style="width: 100%; max-width: 800px; margin: 0 auto; padding: 0; background: white; color: #000; font-family: Arial, sans-serif; box-sizing: border-box;">
      ...
      <div style="padding: 20px; box-sizing: border-box;">
        ...
        ${data.notes ? `<div style="border-left: 3px solid #3b82f6; padding: 12px; margin-bottom: 15px; background: #f0f9ff; font-size: 11px; color: #0c4a6e; white-space: pre-line;"><strong>Notes:</strong><br>${data.notes}</div>` : ''}
...
function renderBigTotal(data, type, numberField, dateField) {
  return `
    <div style="width: 100%; max-width: 800px; margin: 0 auto; padding: 20px; background: white; color: #000; font-family: Arial, sans-serif; box-sizing: border-box;">
        ...
        <tbody>
          ${data.items?.map(item => `
            <tr style="border-bottom: 1px solid #ddd;">
              ...
              <td style="padding: 8px; text-align: center; white-space: nowrap;">${item.quantity ?? item.qty ?? 1}</td>
              <td style="padding: 8px; text-align: right; white-space: nowrap;">$${parseFloat(item.unit_price ?? item.price ?? 0).toFixed(2)}</td>
      ...
      ${data.notes ? `<div style="border: 1px solid #ddd; padding: 12px; margin-bottom: 15px; font-size: 11px; color: #666; white-space: pre-line;"><strong>Notes:</strong><br>${data.notes}</div>` : ''}
