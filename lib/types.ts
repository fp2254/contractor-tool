    ...
    Tables: {
      ...
      org_settings: {
        Row: {
          ...
          quote_followup_days: string | null;
          invoice_reminder_before: number | null;
          invoice_reminder_after: number | null;
          quote_sent_template: string | null;
